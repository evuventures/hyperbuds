...
const SignInForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 4. Send token to backend to start session
  ...
  return (
    <main className='flex items-center justify-center gap-5 m-10 lg:mr-10 lg:mt-10 md:mt-10 lg:m-0'>
      <div className='hidden lg:block'>
        <Image src={'/images/signin.png'} alt="Logo" width={600} height={100} className='!h-[650px] lg:w-[500px]' />
      </div>

      <div className='flex flex-col items-center justify-center min-w-2xs h-fit'>
        <div className='flex flex-col gap-3 mb-5'>
          <p className="text-black text-base md:text-lg lg:text-xl">Connect, Collaborate, Grow</p>
          <h2 className='text-3xl md:text-4xl lg:text-5xl text-black'>
            {isSignup ? 'Create an account on' : 'Sign in to'} <span className='text-[#A259FF]'>Hyperbuds</span>
          </h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white p-2 w-full">
          <div className="w-full mb-4">
            ...
            <div className="relative w-full">
              <input
                ...
                required
              />
              <Image src="/images/email-icon.svg" alt="email" width={24} height={24} className="absolute right-3 top-1/2 -translate-y-1/2" />
            </div>
          </div>
          ...
          <div className="w-full mb-4">
            ...
            <div className="relative w-full">
              <input
                ...
                required
              />
              <Image src="/images/password-icon.svg" alt="password" width={24} height={24} className="absolute right-3 top-1/2 -translate-y-1/2" />
            </div>
          </div>
          ...
          <div className="flex items-center justify-between mb-5">
            ...
            <Link href="#" className="text-red-600 text-base md:text-lg">Forgot password?</Link>
          </div>
          ...
          <div className='flex flex-col items-center gap-4'>
            ...
            <p className="text-center text-sm font-normal">
              {isSignup ? (
                ...
                <>Don&apos;t have an account? <Link href="/auth/signup" className="text-blue-600 hover:underline cursor-pointer">Sign up</Link></>
              )}
            </p>
          </div>
        </form>
