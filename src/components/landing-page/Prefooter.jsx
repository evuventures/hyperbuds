...
const Prefooter = () => {
  return (
    <section className="mx-8 lg:mx-40 my-10 lg:my-20 px-16 lg:px-16 py-10 lg:py-20 bg-linear-to-r from-[#A259FF] to-[#0011FF] flex flex-col lg:flex-row items-center justify-between rounded-xl text-white gap-6">
