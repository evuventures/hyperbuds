...
const Hero = ({ heading, subheading, ratings }) => {
  ...
  return (
    <main className="relative min-h-screen bg-linear-to-br from-slate-50 via-white to-purple-50/30 overflow-hidden">
      {/* Background Elements */}
      ...
      {/* Floating Elements */}
      <motion.div
        className="absolute top-20 right-20 w-32 h-32 bg-linear-to-br from-purple-400/20 to-blue-600/20 rounded-full blur-xl"
        animate={{
          y: [0, -20, 0],
          rotate: [0, 180, 360],
        }}
      ...
      />
      <motion.div
        className="absolute bottom-40 left-10 w-24 h-24 bg-linear-to-br from-blue-400/20 to-purple-600/20 rounded-full blur-xl"
        animate={{
          y: [0, 20, 0],
          rotate: [360, 180, 0],
        }}
      ...
      <div className="relative z-10 mt-16 lg:mt-24 px-6 py-20 md:px-12 lg:px-24 flex flex-col lg:flex-row justify-between items-center gap-16">
        ...
        >
          ...
          >
            <div className="grid grid-cols-2 gap-6 mb-8">
              ...
              >
                <div className="absolute inset-0 bg-linear-to-br from-purple-500/20 to-blue-700/20 rounded-2xl blur-lg transform -rotate-2" />
                <Image 
                  src='/images/rec1.png' 
                  alt="hero img" 
                  width={300} 
                  height={200} 
                  className="relative w-full h-45 object-cover rounded-2xl shadow-2xl border border-white/20 backdrop-blur-sm"
                />
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <div className="absolute inset-0 bg-linear-to-br from-blue-500/20 to-purple-700/20 rounded-2xl blur-lg transform rotate-2" />
                <Image 
                  src='/images/rec2.png' 
                  alt="hero img" 
                  width={300} 
          ...
          <motion.div className="space-y-6" variants={fadeUp} custom={0.2}>
            <div className="relative">
              <h1 className="text-5xl lg:text-6xl xl:text-7xl font-bold font-lato bg-linear-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent leading-tight">
                {heading}
              </h1>
              <div className="absolute -top-2 -left-2 w-20 h-20 bg-linear-to-br from-purple-500/10 to-blue-700/10 rounded-full blur-2xl" />
            </div>
            ...
            <div className="flex items-center">
              {["/images/user5.png", "/images/user1.png", "/images/user2.png", "/images/user3.png", "/images/user4.png"].map(
                (userPath, index) => (
                  ...
                  >
                    <div className="absolute inset-0 bg-linear-to-br from-purple-500/30 to-blue-700/30 rounded-full blur-md" />
                    <Image
                      src={userPath}
                      alt={`user-${index}`}
                      width={56}
          ...
          >
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 bg-linear-to-r from-purple-500 to-blue-700 rounded-full" />
          </motion.div>
          ...
          >
            {ratings &&
              ratings.map((item, index) => (
                ...
                >
                  <div className="relative">
                    <h3 className="text-2xl lg:text-3xl font-bold bg-linear-to-r from-purple-600 to-blue-700 bg-clip-text text-transparent">
                      {item.value}
                    </h3>
        ...
        >
          ...
          >
            {/* Background Glow */}
            <div className="absolute inset-0 bg-linear-to-br from-purple-500/30 to-blue-700/30 rounded-3xl blur-2xl transform -rotate-1 scale-110" />
            ...
            <div className="relative">
              <Image 
                ...
                width={600} 
                height={400} 
                className="w-full h-125 lg:h-150 object-cover rounded-3xl shadow-2xl border border-white/20 backdrop-blur-sm"
              />
              
              {/* Overlay Gradient */}
              <div className="absolute inset-0 bg-linear-to-t from-black/10 via-transparent to-white/10 rounded-3xl" />
