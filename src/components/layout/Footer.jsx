      ...
      <div className="flex flex-col lg:flex-row justify-between gap-8">
        ...
        <div className="flex-2 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link href="/about" className="block hover:text-purple-500 transition">
                  About
                </Link>
              </li>
              <li>
                <Link href="/careers" className="block hover:text-purple-500 transition">
                  Careers
                </Link>
              </li>
              <li>AI Matchmaker</li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <Link href="mailto:info@hyperbuds.com">info@hyperbuds.com</Link>
